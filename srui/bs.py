...
def change_audio(input_path, output_dir):
    # 读取音频文件
...
# 指定输入文件路径、输出文件夹路径
input_path = r"D:\HuaweiMoveData\Users\matebook14s\Desktop\srui\train\train_7.wav"
output_path = r"D:\HuaweiMoveData\Users\matebook14s\Desktop\srui\test\test_voice.wav"
